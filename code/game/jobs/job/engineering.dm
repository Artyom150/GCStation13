/datum/job/chief_engineer
	title = "Chief Engineering Specialist"
	flag = CHIEF
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_or_collect(new /obj/item/device/radio/headset/heads/ces(H), slot_l_ear)
		switch(H.backbag)
...
/datum/job/engineer
	...
	total_positions = 5
	spawn_positions = 5
	supervisors = "the Chief Engineering Specialist"
