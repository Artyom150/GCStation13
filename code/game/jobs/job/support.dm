...
/datum/job/bartender
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Chief of Staff"
...
/datum/job/cargo_tech
	...
	total_positions = 2
	spawn_positions = 2
	supervisors = "the Ship Quartermaster"
	selection_color = "#dddddd"
	idtype = /obj/item/weapon/card/id/supply
	access = list(access_maint_tunnels, access_mailsorting, access_cargo, access_cargo_bot, access_qm, access_mint, access_mining, access_mining_station, access_mineral_storeroom)
...
/datum/job/mining
	title = "Logistics, Asteroid Miner"
	flag = MINER
	department_flag = SUPPORT
	total_positions = 3
	spawn_positions = 3
...
/datum/job/janitor
	title = "Navy Sanitation Specialist"
	flag = JANITOR
	department_flag = SUPPORT
	total_positions = 2
	spawn_positions = 2
	...
	alt_titles = list("Navy Custodial Technician")
