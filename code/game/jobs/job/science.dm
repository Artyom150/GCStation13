/datum/job/rd
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/cnr(H), slot_l_ear)
...
/datum/job/scientist
	title = "Navy Researcher"
	flag = SCIENTIST
	department_flag = MEDSCI
	total_positions = 6
	spawn_positions = 6
	supervisors = "the Chief Navy Researcher"
