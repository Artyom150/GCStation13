/datum/job/hos
	title = "Imperial Marine Officer, 1st Lt."
	flag = HOS
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_or_collect(new /obj/item/device/radio/headset/heads/imo/alt(H), slot_l_ear)
		...
		H.equip_or_collect(new /obj/item/weapon/gun/projectile/automatic/ar57, slot_s_store)
...
/datum/job/warden
	title = "Imperial Detention Officer, 1st Sgt."
	flag = WARDEN
	department_flag = ENGSEC
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Imperial Marine Officer, 1st Lt."
...
//		H.equip_or_collect(new /obj/item/clothing/mask/gas(H), slot_wear_mask) //Grab one from the armory you donk
		...
		H.equip_or_collect(new /obj/item/weapon/gun/energy/gun/advtaser(H), slot_belt)
		H.equip_or_collect(new /obj/item/weapon/gun/projectile/automatic/ar57, slot_s_store)
		H.equip_or_collect(new /obj/item/weapon/storage/box/survival(H), slot_in_backpack)
		H.equip_or_collect(new /obj/item/weapon/restraints/handcuffs(H), slot_in_backpack)
		var/obj/item/weapon/implant/loyalty/L = new/obj/item/weapon/implant/loyalty(H)
