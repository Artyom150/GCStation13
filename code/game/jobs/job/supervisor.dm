...
/datum/job/captain
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "Imperial Navy Admiralty"
...
/datum/job/hop
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_or_collect(new /obj/item/device/radio/headset/heads/cos(H), slot_l_ear)
		switch(H.backbag)
...
/datum/job/nanotrasenrep
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_or_collect(new /obj/item/device/radio/headset/heads/navlia(H), slot_l_ear)
		switch(H.backbag)
			if(2) H.equip_or_collect(new /obj/item/weapon/storage/backpack(H), slot_back)
			if(3) H.equip_or_collect(new /obj/item/weapon/storage/backpack/satchel_norm(H), slot_back)
			if(4) H.equip_or_collect(new /obj/item/weapon/storage/backpack/satchel(H), slot_back)
...
/datum/job/blueshield
	title = "Navy Bodyguard"
	flag = BLUESHIELD
	department_flag = KARMA
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Navy Liaison"
	selection_color = "#ddddff"
	idtype = /obj/item/weapon/card/id/nanotrasen
	req_admin_notify = 1
	minimal_player_age = 21
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_or_collect(new /obj/item/device/radio/headset/heads/navguard/alt(H), slot_l_ear)
		switch(H.backbag)
...
/datum/job/judge
	title = "Navy Judicial Officer"
	flag = JUDGE
	department_flag = KARMA
	total_positions = 1
	spawn_positions = 1
	supervisors = "the Imperial Navy Tribunal"
	selection_color = "#ddddff"
	idtype = /obj/item/weapon/card/id/nanotrasen
	req_admin_notify = 1
	minimal_player_age = 30
	...
	equip(var/mob/living/carbon/human/H)
		if(!H)	return 0
		H.equip_or_collect(new /obj/item/device/radio/headset/heads/navyjudoff/alt(H), slot_l_ear)
		switch(H.backbag)
			if(2) H.equip_or_collect(new /obj/item/weapon/storage/backpack(H), slot_back)
			if(3) H.equip_or_collect(new /obj/item/weapon/storage/backpack/satchel_norm(H), slot_back)
			if(4) H.equip_or_collect(new /obj/item/weapon/storage/backpack/satchel(H), slot_back)
...
/datum/job/lawyer
	...
	total_positions = 2
	spawn_positions = 2
	supervisors = "the Navy Judicial Officer"
	selection_color = "#ddddff"
