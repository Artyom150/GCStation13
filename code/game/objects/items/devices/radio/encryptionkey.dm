...
/obj/item/device/encryptionkey/heads/cnr
	name = "Chief Navy Researcher's Encryption Key"
	icon_state = "rd_cypherkey"
	channels = list("Science" = 1, "Command" = 1)

/obj/item/device/encryptionkey/heads/imo
	name = "Imperial Marine Officer's Encryption Key"
	icon_state = "hos_cypherkey"
	channels = list("Security" = 1, "Command" = 1)

/obj/item/device/encryptionkey/heads/ces
	name = "Chief Engineering Specialist's Encryption Key"
	icon_state = "ce_cypherkey"
	channels = list("Engineering" = 1, "Command" = 1)

/obj/item/device/encryptionkey/heads/cms
	name = "Chief Medical Specialist's Encryption Key"
	icon_state = "cmo_cypherkey"
	channels = list("Medical" = 1, "Command" = 1)

/obj/item/device/encryptionkey/heads/cos
	name = "Chief of Staff's Encryption Key"
	icon_state = "hop_cypherkey"
	channels = list("Supply" = 1, "Service" = 1, "Security" = 0, "Command" = 1)

/obj/item/device/encryptionkey/heads/navlia
	name = "Navy Liaison's Encryption Key"
	icon_state = "com_cypherkey"
	channels = list("Command" = 1, "Security" = 0, "Engineering" = 0, "Science" = 0, "Medical" = 0, "Supply" = 0, "Service" = 0)

/obj/item/device/encryptionkey/heads/navyjudoff
	name = "Navy Judicial Officer's Encryption Key"
	icon_state = "com_cypherkey"
	channels = list("Command" = 1, "Security" = 1)

/obj/item/device/encryptionkey/heads/navguard
	name = "Navy Bodyguard's Encryption Key"
	icon_state = "com_cypherkey"
	channels = list("Command" = 1)
...
/obj/item/device/encryptionkey/ert
	name = "SOG ERT Radio Encryption Key"
