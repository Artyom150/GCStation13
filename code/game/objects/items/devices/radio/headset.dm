...
/obj/item/device/radio/headset/headset_eng
	...
	desc = "When the engineering specialists wish to chat like girls."
...
/obj/item/device/radio/headset/heads/cnr
	name = "chief navy researcher's headset"
	desc = "Headset of the researching God."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/cnr

/obj/item/device/radio/headset/heads/imo
	name = "imperial marine officer's headset"
	desc = "The headset of the man who protects your worthless lives."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/imo

/obj/item/device/radio/headset/heads/imo/alt
	name = "\proper the imperial marine officer's bowman headset"
	desc = "The headset of the man in charge of keeping order and protecting the ship. Protects ears from flashbangs."
	flags = EARBANGPROTECT
	icon_state = "com_headset_alt"
	item_state = "com_headset_alt"

/obj/item/device/radio/headset/heads/ces
	name = "chief engineering specialist's headset"
	desc = "The headset of the guy who is in charge of morons."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/ces

/obj/item/device/radio/headset/heads/cms
	name = "chief medical specialist's headset"
	desc = "The headset of the highly trained medical chief."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/cms

/obj/item/device/radio/headset/heads/cos
	name = "chief of staff's headset"
...
/obj/item/device/radio/headset/heads/navlia
	name = "navy liaison's headset"
	desc = "The headset of the Navy Liaison."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/navlia

/obj/item/device/radio/headset/heads/navyjudoff
	name = "navy judicial officer's headset"
	desc = "The headset of the Navy Judicial Officer."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/navyjudoff

/obj/item/device/radio/headset/heads/navyjudoff/alt
	name = "\proper navy judicial officer's bowman headset"
	desc = "The headset of the Navy Judicial Officer. Protects ears from flashbangs."
	flags = EARBANGPROTECT
	icon_state = "com_headset_alt"
	item_state = "com_headset_alt"

/obj/item/device/radio/headset/heads/navguard
	name = "navy bodyguard's headset"
	desc = "The headset of the Navy Bodyguard."
	icon_state = "com_headset"
	item_state = "headset"
	ks2type = /obj/item/device/encryptionkey/heads/navguard

/obj/item/device/radio/headset/heads/navguard/alt
	name = "\proper navy bodyguard's bowman headset"
	desc = "The headset of the Navy Bodyguard. Protects ears from flashbangs."
	flags = EARBANGPROTECT
	icon_state = "com_headset_alt"
	item_state = "com_headset_alt"
