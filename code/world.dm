...
/world/proc/update_status()
	...
	s += "<b>Exploration Destroyer Kapalla</b>";
	s += " ("
	s += "<a href=\"http://galacticconquests.freeforums.net/forum\">" //Change this to wherever you want the hub to link to.
	s += "[game_version]"
	s += "</a>"
	s += ")"
	s += "<br>A server based off of the many exploits of the roleplay Galactic Conquest<br>"
